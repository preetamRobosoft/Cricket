...
//            print(parameters)
//
//            let requestData = (UIImage(named: "camera")?.jpegData(compressionQuality: 0.9))!
//            let boundary = UUID().uuidString
//            let fullData = photoDataToFormData(data: requestData, boundary: boundary, fileName: "fileName")
//
